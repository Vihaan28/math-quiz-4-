function send(){
  ...
  var number1 = document.getElementById("n1_input").value;
  var number2 = document.getElementById("n2_input").value;
  ...
  document.getElementById("n1_input").value = "";
  document.getElementById("n2_input").value = "";
